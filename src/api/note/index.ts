...
export default {
  ...
  getNoteListAll: async (payload) => {
    const { data } = await request.post("/note/getNoteListAll", {
      ...payload,
    });
    return data;
  },
  ...
  getNoteListPublished: async (payload) => {
    const { data } = await request.post("/note/getNoteListPublished", {
      ...payload,
    });
    return data;
  },
  ...
  addNote: async (payload: addNoteReq) => {
    const { data } = await request.post("/note/addNote", {
      ...payload,
    });
    return data;
  },
  ...
  editNote: async (payload: any) => {
    const { data } = await request.post("/note/editNote", {
      ...payload,
    });
    return data;
  },
  ...
  adornNote: async (payload: any) => {
    const { data } = await request.post("/note/adornNote", {
      ...payload,
    });
    return data;
  },
  ...
  removeNote: async (payload: removeNoteReq) => {
    const { data } = await request.post("/note/removeNote", {
      ...payload,
    });
    return data;
  },
